                            ...
                            for t in range(0,NBLOCK-1):
                                ...
                                for k2 in range(0,HEIGHT):
                                    ...
                                    #高さ０以外での積み替え
                                        ...
                                        m.addConstr(rel_upp[i1,j1,k1,i2,j2,k2,t]<=1-upp[i1,j1,k1,i2,j2,t])
                                    m.addConstr(rel_upp[i1,j1,k1,i2,j2,k2,t]>=x_sum)
