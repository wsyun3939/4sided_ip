            ...
            for k in range(0,WIDTH):
                for t in range(0,NBLOCK-1):
                    for l in range(0,DEPTH):
                        ...
                        upper_sum=gp.quicksum(b[k,l_dash,n,t] for n in range(t+1,NBLOCK) for l_dash in range(l+1,DEPTH))+dir[t,0]*gp.quicksum(x[i,j_dash,k,l_dash,n,t] for j_dash in range(j+1,DEPTH) for l_dash in range(l+1,DEPTH) for n in range(t+1,NBLOCK))+dir[t,1]*gp.quicksum(x[i_dash,j,k,l_dash,n,t] for i_dash in range(i+1,WIDTH) for l_dash in range(l+1,DEPTH) for n in range(t+1,NBLOCK))+dir[t,2]*gp.quicksum(x[i,j_dash,k,l_dash,n,t] for j_dash in range(0,j) for l_dash in range(l+1,DEPTH) for n in range(t+1,NBLOCK))+dir[t,3]*gp.quicksum(x[i_dash,j,k,l_dash,n,t] for i_dash in range(0,i) for l_dash in range(l+1,DEPTH) for n in range(t+1,NBLOCK))
                        righter_sum=gp.quicksum(b[k_dash,l,n,t] for n in range(t+1,NBLOCK) for k_dash in range(k+1,WIDTH))+dir[t,0]*gp.quicksum(x[i,j_dash,k_dash,l_dash,n,t] for j_dash in range(j+1,DEPTH) for k_dash in range(k+1,WIDTH) for n in range(t+1,NBLOCK))+dir[t,1]*gp.quicksum(x[i_dash,j,k_dash,l,n,t] for i_dash in range(i+1,WIDTH) for k_dash in range(k+1,WIDTH) for n in range(t+1,NBLOCK))+dir[t,2]*gp.quicksum(x[i,j_dash,k_dash,l,n,t] for j_dash in range(0,j) for k_dash in range(k+1,WIDTH) for n in range(t+1,NBLOCK))+dir[t,3]*gp.quicksum(x[i_dash,j,k_dash,l,n,t] for i_dash in range(0,i) for k_dash in range(k+1,WIDTH) for n in range(t+1,NBLOCK))
                        downer_sum=gp.quicksum(b[k,l_dash,n,t] for n in range(t+1,NBLOCK) for l_dash in range(0,l))+dir[t,0]*gp.quicksum(x[i,j_dash,k,l_dash,n,t] for j_dash in range(j+1,DEPTH) for l_dash in range(0,l) for n in range(t+1,NBLOCK))+dir[t,1]*gp.quicksum(x[i_dash,j,k,l_dash,n,t] for i_dash in range(i+1,WIDTH) for l_dash in range(0,l) for n in range(t+1,NBLOCK))+dir[t,2]*gp.quicksum(x[i,j_dash,k,l_dash,n,t] for j_dash in range(0,j) for l_dash in range(0,l) for n in range(t+1,NBLOCK))+dir[t,3]*gp.quicksum(x[i_dash,j,k,l_dash,n,t] for i_dash in range(0,i) for l_dash in range(0,l) for n in range(t+1,NBLOCK))
                        lefter_sum=gp.quicksum(b[k_dash,l,n,t] for n in range(t+1,NBLOCK) for k_dash in range(0,k))+dir[t,0]*gp.quicksum(x[i,j_dash,k_dash,l,n,t] for j_dash in range(j+1,DEPTH) for k_dash in range(0,k) for n in range(t+1,NBLOCK))+dir[t,1]*gp.quicksum(x[i_dash,j,k_dash,l,n,t] for i_dash in range(i+1,WIDTH) for k_dash in range(0,k) for n in range(t+1,NBLOCK))+dir[t,2]*gp.quicksum(x[i,j_dash,k_dash,l,n,t] for j_dash in range(0,j) for k_dash in range(0,k) for n in range(t+1,NBLOCK))+dir[t,3]*gp.quicksum(x[i_dash,j,k_dash,l,n,t] for i_dash in range(0,i) for k_dash in range(0,k) for n in range(t+1,NBLOCK))
                        if l>=j:
